    ...
    function wbc_extended_example( $demo_active_import , $demo_directory_path ) {
        ...
        */
        ...
        if ( class_exists( 'RevSlider' ) ) {
            $wbc_sliders_array = array(
                'Main Home' => array('bellavita_theme_slider1.zip', 'bellavita_theme_slider2.zip', 'bellavita_theme_slider3.zip', 'bellavita_theme_slider4.zip', ),
                'Home Consulting' => array('bellavita_theme_slider1.zip', 'bellavita_theme_slider2.zip', 'bellavita_theme_slider3.zip', 'bellavita_theme_slider4.zip', ),
                'Home Investments' => array('bellavita_theme_slider1.zip', 'bellavita_theme_slider2.zip', 'bellavita_theme_slider3.zip', 'bellavita_theme_slider4.zip', ),
            );
        ...
        */
        ...
        $wbc_home_pages = array(
            'Main Home'   => 'Home Insurance',
            'Home Consulting'   => 'Home Consulting',
            'Home Investments'   => 'Home Investments',
        );
