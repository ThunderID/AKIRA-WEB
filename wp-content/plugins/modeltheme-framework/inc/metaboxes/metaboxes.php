...
$line_icons_font_i = array(
      ...
      */
      $meta_boxes['our_services_metaboxs'] = array(
            ...
            'title'      => __( 'MT Services Custom Options', 'modeltheme' ),
            ...
            'fields'     => array(
                  array(
                        'name'       => __( 'Service Subtitle', 'modeltheme' ),
                        'desc'       => __( 'Eg: Efficiently unleash cross-media information', 'modeltheme' ),
                        'id'         => $prefix . 'service_subtitle',
                        'type'       => 'text',
                  ),
                  array(
                        'name'    => __( 'Select Icons Library', 'modeltheme' ),
                        'desc'    => __( 'If "Yes" - Page Options will rewrite Theme Options', 'modeltheme' ),
                        'id'      => $prefix . 'select_font',
                        'type'    => 'select',
                        'options' => array(
                            'font-awesome-icons' => __( 'Font Awesome', 'modeltheme' ),
                            'simple-line-icons' => __( 'Simple Line Icons', 'modeltheme' ),
                        ),
                        'default' => 'font-awesome-icons',
                  ),
                  array(
                        'name'    => 'Select a Line Icon',
                        'id'      => $prefix . 'font-simple-line-icons',
                        'type'    => 'radio',
      ...
      */
      $meta_boxes['testimonials_metaboxs'] = array(
            ...
            'title'      => __( 'MT Testimonials Custom Options', 'modeltheme' ),
            ...
            'fields'     => array(
                  ...
                  array(
                        'name'    => __( 'Testimonial border color', 'modeltheme' ),
                        'desc'    => __( 'Set the border color of the testimonial', 'modeltheme' ),
            ...
            'fields'     => array(
                  ...
                  */
                  ...
                  array(
                      ...
                      'type'    => 'radio',
                      'options' => array(
                          'header1'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/1.png" alt="Header v1" />',
                          'header2'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/2.png" alt="Header v2" />',
                          'header3'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/3.png" alt="Header v3" />',
                          'header4'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/4.png" alt="Header v4" />',
                          // 'header5'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/5.png" alt="Header v5" />',
                          // 'header6'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/6.png" alt="Header v6" />',
                          // 'header7'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/7.png" alt="Header v7" />',
                          // 'header8'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/8.png" alt="Header v8" />',
                          // 'header9'        => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/9.png" alt="Header v9" />',
                          // 'header10'       => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/10.png" alt="Header v10" />',
                          // 'header11'       => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/11.png" alt="Header v11" />',
                          // 'header12'       => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/12.png" alt="Header v12" />',
                          // 'header13'       => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/13.png" alt="Header v13" />',
                          // 'header14'       => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/14.png" alt="Header v14" />',
                          // 'header15'       => '<img src="'.plugins_url().'/modeltheme-framework/inc/metaboxes/assets/headers/15.png" alt="Header v15" />',
                      ),
                      'default' => 'first_header',
                  ),
                  array(
                  ...
                  */
                  ...
                  array(
                        'name' => __( 'Disable Page Preloader', 'modeltheme' ),
                        'desc' => __( 'Check to disable page preloader', 'modeltheme' ),
                        'id'   => 'mt_page_preloader_status',
                        'type' => 'checkbox',
                  ),
                  array(
                        'name'    => __( 'Page Preloader Background Color', 'modeltheme' ),
                        'desc'    => __( 'Set the background color of the Page Preloader(Default: #04ABE9)', 'modeltheme' ),
