...
function modeltheme_icon_list_item($params, $content) {
  ...
  $html .= '<div class="mt-icon-list-item">';
      ...
      $html .= '<div class="mt-icon-list-icon-holder">
                ...
                <p class="mt-icon-list-text" style="font-size: '.esc_attr($list_icon_title_size).'px; color: '.esc_attr($list_icon_title_color).'; font-weight:'.esc_attr($list_icon_title_weight).';">'.esc_attr($list_icon_title).'</p>
                <p class="mt-icon-list-text-subtitle">'.esc_attr($list_icon_subtitle).'</p>';
  ...
  vc_map( array(
     ...
     "params" => array(
        ...
        array(
          "group" => "Label Setup",
          "type" => "textfield",
          "heading" => esc_attr__("Title Weight", 'modeltheme'),
          "param_name" => "list_icon_title_weight",
          "std" => '',
          "holder" => "div",
          "class" => "",
          "description" => ""
