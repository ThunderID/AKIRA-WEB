...
// THUMBNAIL
$post_img = '';
$thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'bellavita_blog_900x550' );
if ($thumbnail_src) {
    ...
    <div class="blog_custom">
        ...
        <?php if ($post_img) { ?>
            ...
            <div class="post-thumbnail">
                <a href="<?php esc_url(get_the_permalink()); ?>" class="relative">
                ...
                <div class="post-excerpt row">
                    ...
                    <p>
                        <a href="<?php echo esc_url(get_the_permalink()); ?>" class="more-link">
                            <?php echo esc_html__( 'Continue Reading', 'bellavita' ); ?> <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        </a>
                    </p>
                    <div class="clearfix"></div>
