...
add_action( 'tgmpa_register', 'bellavita_register_plugins' );
 ...
 */
function bellavita_register_plugins() {
    /*
    ...
    $plugins = array(
        ...
        array(
            'name'                  => esc_html__('WPBakery Visual Composer', 'bellavita'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('Revolution Slider', 'bellavita'), // The plugin name
        ...
        array(
            'name'                  => esc_html__('Parallax Backgrounds for VC', 'bellavita'), // The plugin name
            'slug'                  => 'parallax-backgrounds-for-vc', // The plugin slug (typically the folder name)
            'source'                => get_template_directory().'/inc/tgm/plugins/parallax-backgrounds-for-vc.zip', // The plugin source.
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name'                  => esc_html__('ModelTheme Framework', 'bellavita'), // The plugin name
            'slug'                  => 'modeltheme-framework', // The plugin slug (typically the folder name)
            'source'                => get_template_directory().'/inc/tgm/plugins/modeltheme-framework.zip', // The plugin source.
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name'                  => esc_html__('Redux Framework', 'bellavita'), // The plugin name
            'slug'                  => 'redux-framework', // The plugin slug (typically the folder name)
            'required'              => true, // If false, the plugin is only 'recommended' instead of required
        ),
        array(
            'name'                  => esc_html__('Contact Form 7', 'bellavita'), // The plugin name
